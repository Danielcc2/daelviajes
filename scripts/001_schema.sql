...
drop policy if exists comentarios_select_publicos on public.comentarios;
...
drop policy if exists comentarios_insert_authed on public.comentarios;
create policy comentarios_insert_authed on public.comentarios for insert with check ( auth.uid() = user_id );
drop policy if exists comentarios_delete_owner_admin on public.comentarios;
...
drop policy if exists itins_select_owner on public.itinerarios_usuario;
create policy itins_select_owner on public.itinerarios_usuario for select using ( auth.uid() = user_id );
drop policy if exists itins_insert_owner on public.itinerarios_usuario;
create policy itins_insert_owner on public.itinerarios_usuario for insert with check ( auth.uid() = user_id );
drop policy if exists itins_update_owner on public.itinerarios_usuario;
...
drop policy if exists itins_delete_owner on public.itinerarios_usuario;
...
drop policy if exists itins_pub_select_all on public.itinerarios_publicos;
create policy itins_pub_select_all on public.itinerarios_publicos for select using ( true );
drop policy if exists itins_pub_mut_admin on public.itinerarios_publicos;
...
drop policy if exists contacto_insert_all on public.mensajes_contacto;
create policy contacto_insert_all on public.mensajes_contacto for insert with check ( true );
drop policy if exists contacto_select_admin on public.mensajes_contacto;
